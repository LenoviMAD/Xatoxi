    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (ventaForm) {
            ...
            file.addEventListener('change', async(e) => {
                ...
                formData.append("type", typeDocSell.options[typeDocSell.selectedIndex].value);
            ...
            typeDocSell.addEventListener('change', async() => {
                /* 
                    ci: 1
                    firma: 2
                    huellas: 3
                */
                if (typeDocSell.options[typeDocSell.selectedIndex].value === '3') {
                    ...
                    btnModalFirma.addEventListener('click', async() => {
                        ...
                        const payload = {
                            ...
                            encoded,
                            type: typeDocSell.options[typeDocSell.selectedIndex].value
                        }
                    ...
                    fileInputSell.classList.remove('hidden')
                }
            })
        }
    })
