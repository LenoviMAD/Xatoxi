    ...
    <div class="modal-dialog">
        ...
        <section class="modal-content">
            <header class="modal-header">
                ...
                <p class="modal__text"><span class="js-translate" data-string="trad_presione_aceptar">Presione aceptar, este código expirará en:</span> <span id="countdown"></span></p>
            </header>
            <aside class="modal-body">
                <input type="text" class="input-otp" disabled name="otpCode" id="otpCode" class="input-otp">
            </aside>
            <footer class="modal-footer">
                <button class="btn btn-semi-rounded js-translate" data-string="trad_aceptar" data-id="btnOtp" aria-label="close modal" data-close>Aceptar</button>
